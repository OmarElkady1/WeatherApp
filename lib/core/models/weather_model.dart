class WeatherModelApi {
  Location1? location;
  Current? current;
  Forecast? forecast;

  WeatherModelApi({this.location, this.current, this.forecast});

  WeatherModelApi.fromJson(Map<String, dynamic> json) {
    location =
        json['location'] != null ? Location1.fromJson(json['location']) : null;
    current =
